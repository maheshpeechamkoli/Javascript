(function(){
    ...
    function MovieListController($scope,MovieService){
        ...
        //gets movie data using plain http
        ...
        function init(){
            $scope.onRangeChanged=function(value){
                
                $scope.rangeChangeMessage='range changed to '+value;
                console.log($scope.rangeChangeMessage);
            };
